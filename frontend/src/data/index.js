...
export const SPIRITS = [
  ...
  {
    id: "WHISKY_IKKA",
    name: "Ikka \"French\" Whisky",
    tagline: "One above all, a rare batch release.",
    description:
      "A rare batch whisky aged in barrel and distilled in Australia, handcrafted and pure. Bold, warming and built to be savoured slowly. 60% ABV.",
    abv: "60%",
    size: "700ml",
    price: 29900,
    category: "retail",
