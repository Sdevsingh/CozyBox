...
export const SPIRITS = [
  // ─── Gin ────────────────────────────────────────────────
  {
    ...
    category: "retail",
    section: "Gin",
    image: "/img/original-gin-min.webp",
    packshot: true,
    badge: "Flagship",
  },
  {
    ...
    category: "retail",
    section: "Gin",
    image: "/img/desert-lime-gin-min.webp",
    packshot: true,
  },
  {
    id: "GIN_NAVAL",
    ...
    category: "retail",
    section: "Gin",
    image: "/img/navel-strength-gin-min.webp",
    packshot: true,
    badge: "High Proof",
  },
  {
  ...
  },
  {
    ...
    description:
      "A warming and comforting spirit with botanical complexity and a smooth finish. Lower in proof and built for a hot toddy, gentle spice and honeyed warmth. Serve warm with lemon and honey. 38% ABV.",
    abv: "38%",
    size: "700ml",
    price: 8800,
    category: "retail",
  ...
  },
  {
    ...
    category: "retail",
    section: "Gin",
    image: "/img/grapefruit-gin.webp",
    packshot: true,
  },
  {
    id: "GIN_HOT_CROSS_BUN",
    name: "Hot Cross Bun Gin",
    tagline: "Warm spice, dried fruit, an Easter classic.",
    description:
      "A seasonal gin infused with warm spice and dried fruit reminiscent of a fresh hot cross bun. Sweet, spiced and irresistibly moreish. 36% ABV.",
    abv: "36%",
    size: "700ml",
    price: 8800,
    category: "retail",
  ...
  },
  {
    ...
    category: "retail",
    section: "Whisky",
    image: "/img/the-malwa.webp",
    packshot: true,
  },
  {
    id: "WHISKY_THAR",
    name: "Thar Whisky",
    tagline: "Rare, bold and unmistakable.",
    description:
      "A rare, bold and unmistakable whisky born of the wild. Sherry cask matured for depth and character, aged in barrel, distilled in Australia. Small batch, 50% ABV.",
    abv: "50%",
    size: "700ml",
    price: 19900,
    category: "retail",
  ...
  },
  {
    id: "WHISKY_IKKA",
    name: "Ikka Whisky",
    tagline: "One above all, a rare batch release.",
    description:
      "A rare batch whisky aged in French oak barrel and distilled in Australia, handcrafted and pure. Bold, warming and built to be savoured slowly. 60% ABV.",
    abv: "60%",
    size: "700ml",
    price: 29900,
    category: "retail",
    section: "Whisky",
    image: "/img/ikka-whisky.webp",
    packshot: true,
    badge: "Rare Batch",
  },
  {
  ...
  },
  {
    id: "IND_JAMUN_VODKA",
    name: "Jamun Vodka",
    tagline: "The unique flavour of Indian jamun, in vodka form.",
    description:
      "A distinctive vodka inspired by the unique flavour of Indian jamun fruit, tart, dark and fruity, the tangy and sweet taste of childhood summers, captured in a vivid pour. 40% ABV.",
    abv: "40%",
    size: "700ml",
    price: 6999,
    category: "retail",
  ...
  },
  {
    ...
    category: "retail",
    section: "Indian Series",
    image: "/img/lahori-jeera-gin.webp",
    packshot: true,
    badge: "Indian Series",
  },
  {
    ...
    description:
      "A refined botanical gin balancing traditional gin craftsmanship with contemporary flavour. Elegant, layered and endlessly sippable, neat or in a classic gin and tonic. 40% ABV.",
    abv: "40%",
    size: "700ml",
    price: 6999,
    category: "retail",
  ...
  },
  {
    ...
    category: "retail",
    section: "Indian Series",
    image: "/img/rose-lychee-gin.webp",
    packshot: true,
    badge: "Indian Series",
  },
  {
  ...
  },
  {
    ...
    category: "retail",
    section: "Indian Series",
    image: "/img/popcorn-vodka.webp",
    packshot: true,
    badge: "Indian Series",
  },
  {
    id: "IND_BLACK",
    name: "Black Velvet Vodka",
    tagline: "Bold, mysterious, unforgettable.",
    description:
      "Bold, mysterious and unforgettable. A striking jet black pour with a smooth, clean character, made to be the centrepiece of any cocktail. 40% ABV.",
    abv: "40%",
    size: "700ml",
    price: 6999,
    category: "retail",
    section: "Vodka",
    image: "/img/black-velvet-vodka.webp",
    packshot: true,
  },
  {
    id: "IND_KALA_KHATTA",
    name: "Kala Khatta Vodka",
    tagline: "Indian jamun berries with a lemon twist.",
    description:
      "A bold vodka infused with Indian jamun berries and a hint of lemon, dark, tangy and unmistakably nostalgic. 40% ABV.",
    abv: "40%",
    size: "700ml",
    price: 6999,
    category: "retail",
    section: "Indian Series",
    image: "/img/kala-khatta-vodka.webp",
    packshot: true,
    badge: "Indian Series",
  },
];
...
export const EVENTS = [
  {
    ...
    category: "Tastings",
    description:
      "Our Wednesday tasting flight. Choose any 3 of our house distilled Fossey's gin flavours, poured across three Glencairn glasses. Taste, sip and discover the range for just $15.",
    highlights: ["Choose any 3", "9 gin flavours", "House distilled"],
    priceFrom: 1500,
  ...
  },
  {
    ...
    description:
      "Good food, great drinks, better together. A shared feast of a cocktail jug, sliders, skewers and a shared platter for $49, the easiest way to do a group night at the Cozy Box.",
    highlights: ["Cocktail jug", "Sliders", "Skewers", "Shared platter"],
    priceFrom: 4900,
    priceUnit: "to share",
  ...
  },
  {
    ...
    description:
      "A hands-on 90-minute masterclass using the full Fossey's Distillery range of gin, vodka, whisky and rum. You'll make three cocktails, enjoy matched bites, and leave with a recipe card.",
